...
class LangchainConnector:
    ...
    def create_retrieval_chain(self, 
                              ...
                              prompt_template: str = None) -> RunnableSerializable:
        """
    ...
    def run_simple_query(self, query: str, prompt_template: str = None) -> str:
        """
    ...
    def set_model(self, model_name: str, provider: str = None, base_url: Optional[str] = None):
        """
